...
/**
 * Admin webscript that revokes a Collabora Online license from a user by removing them
 * from the licensed group.
 * <p>
 * POST /collabora/license/revoke?user={user}
 */
public class LicenseRevokeWebScript extends DeclarativeWebScript {
	...
	protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
		...
		featureRestrictionService.revokeLicense(user);
