...
public class LOOLPutFileWebScript extends LOOLAbstractWebScript {
	...
	public static final String LOOL_AUTOSAVE = "collabora:autosave";
	...
	public void execute(final WebScriptRequest req, final WebScriptResponse res) throws IOException {
		...
		if (!checkTimestamp(hdrTimestamp, modified, res)) {
			logger.warn("checkTimestamp is not success");
			return;
		}
	 ...
	 * @throws IOException
	 */
	private boolean checkTimestamp(final String hdrTimestamp, final Date modified, final WebScriptResponse res)
			throws IOException {
